...
$packages["main"]=(function(){var $pkg={},$init,B,A,N,O,P,Q,C,D,E,F,G,H,I,J,K,L,M;B=$packages["github.com/gopherjs/gopherjs/js"];A=$packages["github.com/gopherjs/jquery"];N=$sliceType($emptyInterface);O=$funcType([A.Event],[],false);P=$ptrType(B.Object);Q=$funcType([P],[],false);C=function(){D();E();I();G();F();H();};D=function(){$clone(A.NewJQuery(new N([new $String(".navbar-burger")])),A.JQuery).On(new N([new $String("click"),new O((function(a){var a;$clone(A.NewJQuery(new N([new $jsObjectPtr(a.Object.currentTarget)])),A.JQuery).ToggleClass(new N([new $String("is-active")]));$clone(A.NewJQuery(new N([new $String(".navbar-menu")])),A.JQuery).ToggleClass(new N([new $String("is-active")]));}))]));};$pkg.ActiveNavbarMenu=D;E=function(){$clone(A.NewJQuery(new N([new $String("#sign-in")])),A.JQuery).On(new N([new $String("click"),new O((function(a){var a;$clone(A.NewJQuery(new N([new $jsObjectPtr(a.Object.currentTarget)])),A.JQuery).ToggleClass(new N([new $String("is-active")]));$clone(A.NewJQuery(new N([new $String("#modal-sign-in")])),A.JQuery).ToggleClass(new N([new $String("is-active")]));}))]));};$pkg.ActiveModalSignIn=E;F=function(){$clone(A.NewJQuery(new N([new $String("#close-sign-up")])),A.JQuery).On(new N([new $String("click"),new O((function(a){var a;$clone(A.NewJQuery(new N([new $String("#modal-sign-up")])),A.JQuery).ToggleClass(new N([new $String("is-active")]));}))]));};$pkg.CloseModalSignUp=F;G=function(){$clone(A.NewJQuery(new N([new $String("#close-sign-in")])),A.JQuery).On(new N([new $String("click"),new O((function(a){var a;$clone(A.NewJQuery(new N([new $String("#modal-sign-in")])),A.JQuery).ToggleClass(new N([new $String("is-active")]));}))]));};$pkg.CloseModalSignIn=G;H=function(){$clone(A.NewJQuery(new N([new $String("#form-sign-up")])),A.JQuery).On(new N([new $String("submit"),new O((function(a){var a,b,c,d,e,f;a.PreventDefault();b=$clone(A.NewJQuery(new N([new $String("#password")])),A.JQuery).Val();c=$clone(A.NewJQuery(new N([new $String("#password2")])),A.JQuery).Val();d=$clone(A.NewJQuery(new N([new $String("#email")])),A.JQuery).Val();e=$clone(A.NewJQuery(new N([new $String("#fullname")])),A.JQuery).Val();if(!(b===c)||b.length<6){J(b,c);return;}f=$clone(A.Post(new N([new $String("/sign-up"),new B.M($makeMap($String.keyFor,[{k:"email",v:new $String(d)},{k:"fullname",v:new $String(e)},{k:"password",v:new $String(b)}]))])),A.Deferred);$clone(f,A.Deferred).Done(new N([new Q((function(g){var g;if($internalize(g.Success,$String)==="false"){K(g);}else{F();}}))]));}))]));};$pkg.HandleSignUp=H;I=function(){$clone(A.NewJQuery(new N([new $String("#sign-up")])),A.JQuery).On(new N([new $String("click"),new O((function(a){var a;M("#email-is-already");M("#not-match-pass");M("#length-pass");$clone(A.NewJQuery(new N([new $String("#email")])),A.JQuery).SetVal(new $String(""));$clone(A.NewJQuery(new N([new $String("#password")])),A.JQuery).SetVal(new $String(""));$clone(A.NewJQuery(new N([new $String("#password2")])),A.JQuery).SetVal(new $String(""));$clone(A.NewJQuery(new N([new $String("#fullname")])),A.JQuery).SetVal(new $String(""));$clone(A.NewJQuery(new N([new $jsObjectPtr(a.Object.currentTarget)])),A.JQuery).ToggleClass(new N([new $String("is-active")]));$clone(A.NewJQuery(new N([new $String("#modal-sign-up")])),A.JQuery).ToggleClass(new N([new $String("is-active")]));}))]));};$pkg.ActiveModalSignUp=I;J=function(a,b){var a,b;if($clone(A.NewJQuery(new N([new $String("#email-is-already")])),A.JQuery).Attr("style")===""){M("#email-is-already");}if(!(a===b)){L("#not-match-pass");}else{M("#not-match-pass");}if(a.length<6){L("#length-pass");}else{M("#length-pass");}};K=function(a){var a,b;b=$internalize(a.Status,$String);if(b==="Email is already in use"){L("#email-is-already");}};L=function(a){var a;$clone(A.NewJQuery(new N([new $String(a)])),A.JQuery).RemoveAttr("style");};M=function(a){var a;$clone(A.NewJQuery(new N([new $String(a)])),A.JQuery).SetAttr(new N([new $String("style"),new $String("display: none;")]));};$init=function(){$pkg.$init=function(){};var $f,$c=false,$s=0,$r;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:$r=B.$init();$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$r=A.$init();$s=2;case 2:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}if($pkg===$mainPkg){C();$mainFinished=true;}}return;}if($f===undefined){$f={$blk:$init};}$f.$s=$s;$f.$r=$r;return $f;};$pkg.$init=$init;return $pkg;})();
$synthesizeMethods();
