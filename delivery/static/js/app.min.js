...
$packages["main"]=(function(){var $pkg={},$init,B,A,J,K,L,M,C,D,E,F,G,H,I;B=$packages["github.com/gopherjs/gopherjs/js"];A=$packages["github.com/gopherjs/jquery"];J=$sliceType($emptyInterface);K=$funcType([A.Event],[],false);L=$ptrType(B.Object);M=$funcType([L],[],false);C=function(){H();D();E();I();G();F();};D=function(){$clone(A.NewJQuery(new J([new $String(".navbar-burger")])),A.JQuery).On(new J([new $String("click"),new K((function(a){var a;$clone(A.NewJQuery(new J([new $jsObjectPtr(a.Object.currentTarget)])),A.JQuery).ToggleClass(new J([new $String("is-active")]));$clone(A.NewJQuery(new J([new $String(".navbar-menu")])),A.JQuery).ToggleClass(new J([new $String("is-active")]));}))]));};$pkg.ActiveNavbarMenu=D;E=function(){$clone(A.NewJQuery(new J([new $String("#sign-in")])),A.JQuery).On(new J([new $String("click"),new K((function(a){var a;$clone(A.NewJQuery(new J([new $jsObjectPtr(a.Object.currentTarget)])),A.JQuery).ToggleClass(new J([new $String("is-active")]));$clone(A.NewJQuery(new J([new $String("#modal-sign-in")])),A.JQuery).ToggleClass(new J([new $String("is-active")]));}))]));};$pkg.ActiveModalSignIn=E;F=function(){$clone(A.NewJQuery(new J([new $String("#close-sign-up")])),A.JQuery).On(new J([new $String("click"),new K((function(a){var a;$clone(A.NewJQuery(new J([new $String("#modal-sign-up")])),A.JQuery).ToggleClass(new J([new $String("is-active")]));}))]));};$pkg.CloseModalSignUp=F;G=function(){$clone(A.NewJQuery(new J([new $String("#close-sign-in")])),A.JQuery).On(new J([new $String("click"),new K((function(a){var a;$clone(A.NewJQuery(new J([new $String("#modal-sign-in")])),A.JQuery).ToggleClass(new J([new $String("is-active")]));}))]));};$pkg.CloseModalSignIn=G;H=function(){$clone(A.NewJQuery(new J([new $String("#form-sign-up")])),A.JQuery).On(new J([new $String("submit"),new K((function(a){var a,b,c,d,e,f;a.PreventDefault();b=$clone(A.NewJQuery(new J([new $String("#password")])),A.JQuery).Val();c=$clone(A.NewJQuery(new J([new $String("#password2")])),A.JQuery).Val();d=$clone(A.NewJQuery(new J([new $String("#email")])),A.JQuery).Val();e=$clone(A.NewJQuery(new J([new $String("#fullname")])),A.JQuery).Val();f=$clone(A.Post(new J([new $String("/sign-up"),new B.M($makeMap($String.keyFor,[{k:"email",v:new $String(d)},{k:"fullname",v:new $String(e)},{k:"password",v:new $String(b)}]))])),A.Deferred);$clone(f,A.Deferred).Done(new J([new M((function(g){var g;console.log($internalize(g.Email,$String));}))]));if(!(b===c)){$clone(A.NewJQuery(new J([new $String("#not-match-pass")])),A.JQuery).RemoveAttr("style");}else{$clone(A.NewJQuery(new J([new $String("#not-match-pass")])),A.JQuery).SetAttr(new J([new $String("style"),new $String("display: none;")]));}if(b.length<6){$clone(A.NewJQuery(new J([new $String("#length-pass")])),A.JQuery).RemoveAttr("style");}else{$clone(A.NewJQuery(new J([new $String("#length-pass")])),A.JQuery).SetAttr(new J([new $String("style"),new $String("display: none;")]));}}))]));};$pkg.HandleSignUp=H;I=function(){$clone(A.NewJQuery(new J([new $String("#sign-up")])),A.JQuery).On(new J([new $String("click"),new K((function(a){var a;$clone(A.NewJQuery(new J([new $String("#length-pass")])),A.JQuery).SetAttr(new J([new $String("style"),new $String("display: none;")]));$clone(A.NewJQuery(new J([new $String("#not-match-pass")])),A.JQuery).SetAttr(new J([new $String("style"),new $String("display: none;")]));$clone(A.NewJQuery(new J([new $String("#email")])),A.JQuery).SetVal(new $String(""));$clone(A.NewJQuery(new J([new $String("#password")])),A.JQuery).SetVal(new $String(""));$clone(A.NewJQuery(new J([new $String("#password2")])),A.JQuery).SetVal(new $String(""));$clone(A.NewJQuery(new J([new $String("#fullname")])),A.JQuery).SetVal(new $String(""));$clone(A.NewJQuery(new J([new $jsObjectPtr(a.Object.currentTarget)])),A.JQuery).ToggleClass(new J([new $String("is-active")]));$clone(A.NewJQuery(new J([new $String("#modal-sign-up")])),A.JQuery).ToggleClass(new J([new $String("is-active")]));}))]));};$pkg.ActiveModalSignUp=I;$init=function(){$pkg.$init=function(){};var $f,$c=false,$s=0,$r;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:$r=B.$init();$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$r=A.$init();$s=2;case 2:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}if($pkg===$mainPkg){C();$mainFinished=true;}}return;}if($f===undefined){$f={$blk:$init};}$f.$s=$s;$f.$r=$r;return $f;};$pkg.$init=$init;return $pkg;})();
$synthesizeMethods();
